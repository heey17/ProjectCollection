...
<table>
<tr><th>이름</th><td>${Designer.designerName}</td></tr>
<tr><th>휴무일</th><td>${Designer.designerOff}</td></tr>
<tr><th>경력</th><td>${Designer.designerCareer}</td></tr>
</table>
<c:choose>
   	
   	<c:when test="${not empty sessionScope.loginUser.userId}">
       <button style="border: 1px solid #DDC3F7; margin:2% 40%;" onclick="location.href='beautyReservationForm?designerCode=${Designer.designerCode}'">예약하기</button>  	
   	</c:when>
