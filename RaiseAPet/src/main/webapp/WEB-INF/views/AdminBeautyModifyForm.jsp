      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="beautyBoardModifyProcess" id="writeForm" method="POST" enctype="multipart/form-data">
                <tr>
                  <th>디자이너 이름</th>
                ...
                <tr>
                  ...
                  <input type="hidden" name="designerImage" value="${beautyView.designerImage }"/>
                </tr>
                <tr>
                  <th>디자이너 휴무일</th>
                ...
                <tr>
                  <th>디자이너 경력</th>
                  <td><textarea name="designerCareer" cols="40" id="editor1" name="editor1" rows="10" data-sample-short>${beautyView.designerCareer }</textarea></td>
                </tr>
                <input type="hidden" value="${beautyView.designerCode }" name="designerCode"/>
                </form>
                <tr>
                  <td colspan="2"><button onclick="window.history.back()">취소</button><button onclick="writeForm.submit()">수정</button>
