        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <tr>
                <th>이벤트 썸네일</th>
                <td><img src="resources/eventFile/${eventView.eventTitleImage }" alt="이벤트 썸네일" style="width:300px;"/></td>
              </tr>
              <tr>
                <th>이벤트 사진</th>
                <td><img src="resources/eventFile/${eventView.eventImage }" alt="이벤트 사진" style="width:500px;"/></td>
              </tr>
              <tr>
                <th>이벤트 내용</th>
              ...
              <tr>
                ...
                <td>
                  ...
                  <fieldset>
                    <legend style="text-align:center; width:50%">쿠폰 정보</legend>
                      <c:if test="${not empty couponView }">
                        <p><h2>${couponView.couponName}</h2></p>
                        <p>${couponView.couponCode}</p>
                        <p>${couponView.couponDate }</p>
                        <p>${couponView.couponSale }</p>
                      </c:if>
              ...
              <tr>
                <td colspan="2"><button onclick="location.href='eventBoardDelete?eventNum=${eventView.eventNum }'">삭제</button><button onclick="location.href='eventBoardModify?eventNum=${eventView.eventNum }'">수정</button>
                        </td>
              </tr>
            </table>
