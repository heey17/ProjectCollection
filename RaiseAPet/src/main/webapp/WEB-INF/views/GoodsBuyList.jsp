      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
			...
			<table style="width:60%;  margin:1% auto;  border: 1px solid black;" >
				<tr><td rowspan="6" style="width:30%"><img src="resources/goodsFile/${buyList.goodsImage1 }" style="width:100%;" alt="용품 사진" style="width:100%;"/></td>
					<td colspan="2">${buyList.goodsName }</td></tr>
				<tr><td colspan="2"><a onclick="goMemberView('${buyList.buyUserId}')">${buyList.buyUserId}</a></td></tr>
							<!-- 미용 예약한 회원 정보 불러오기 -->
							<script>
								function goMemberView(userId){
									...
									document.body.appendChild(form);
							         ...
							         window.open("adminMemberView", "memberForm", "width=600, height=500, left="+couponX + ", top="+couponY);
								
									 form.submit();
								}
								</script>
				<tr><td>${buyList.buyPayment }</td><td><button onclick="">배송중으로 변경</button></td></tr>
				<tr><td colspan="2">${buyList.buyCount} 개 / ${buyList.buyPrice} 원</td></tr>
				<tr><td colspan="2">${buyList.buyAddress }</td></tr>
			</table>
		</c:forEach>
		<!-- 페이징 구간 -->
