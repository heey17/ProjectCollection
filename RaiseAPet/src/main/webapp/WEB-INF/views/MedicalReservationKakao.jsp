...
<script>
	...
	function kakaoPay(){
		$.ajax({
			type : 'POST',
			url :"medicalKakaoPayment",
			data :{
				"medicalReserveDate":"${medical.medicalReserveDate}",
				"medicalReserveTime":"${medical.medicalReserveTime}",
				"medicalReserveAnimalKind" : "${medical.medicalReserveAnimalKind}",
				"medicalReserveAnimalAge":${medical.medicalReserveAnimalAge},
