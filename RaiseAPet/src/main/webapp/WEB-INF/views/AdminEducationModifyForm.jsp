...
<script>
	$(document).ready(function() {
		 $('input:checkbox[name="eduAnimalKinds"]').each(function() {
			 if(this.value == '${educationView.eduAnimalKinds[0]}'){ //값 비교
			     this.checked = true; //checked 처리
			  }
			 if(this.value == '${educationView.eduAnimalKinds[1]}'){ //값 비교
			       this.checked = true; //checked 처리
			 }
		});
	});
      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="educationBoardModifyProcess" id="writeForm" method="POST" enctype="multipart/form-data">
                <tr>
                  <th>제목</th>
                ...
                <tr>
                  <th>썸네일</th>
                  <td><img src="resources/educationFile/${educationView.eduImage }" alt="영상 썸네일" width="30%;"/>
                    <input type="file" name="eduImageFile"/></td>
                    <input type="hidden" name="eduImage" value="${educationView.eduImage }">
                </tr>
                <tr>
                  <th>비디오</th>
                  <td><textarea name="eduVideo" cols="120" rows="5" style="resize: none;">${educationView.eduVideo }</textarea></td>
                </tr>
                <tr>
	              	<th>교육 가능한 동물 종류</th>
	              	<td><input type="checkbox" name="eduAnimalKinds" value="강아지"/>강아지<br/>
	              		<input type="checkbox" name="eduAnimalKinds" value="고양이"/>고양이
	              	</td>
              	</tr>
                <tr>
                  <th>내용</th>
                  <td><textarea name="eduContents" cols="40" id="editor1" name="editor1" rows="10" data-sample-short>${educationView.eduContents }</textarea>
                    <input type="hidden" name="eduNum" value="${educationView.eduNum }"></td>
                </tr>
                </form>
                <tr>
                  <td colspan="2"><button onclick="window.history.back()">취소</button>
                  					<button onclick="writeForm.submit()">작성</button>
                                    </td>
                </tr>
              </table>
