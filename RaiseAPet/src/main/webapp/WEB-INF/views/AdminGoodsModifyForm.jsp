      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="goodsBoardModifyProcess" id="writeForm" method="POST" enctype="multipart/form-data">
                <tr>
                  <th>용품 이름</th>
                ...
                <tr>
                  <th>용품 사진</th>
                  <td><img src="resources/goodsFile/${goodsView.goodsImage1 }" style="width:19%;" alt="용품 사진"/>
                    <img src="resources/goodsFile/${goodsView.goodsImage2 }" style="width:19%;" alt="용품 사진"/>
                    <img src="resources/goodsFile/${goodsView.goodsImage3 }"  style="width:19%;"alt="용품 사진"/>
                    <img src="resources/goodsFile/${goodsView.goodsImage4 }" style="width:19%;" alt="용품 사진"/>
                    <img src="resources/goodsFile/${goodsView.goodsImage5 }" style="width:19%;" alt="용품 사진"/>
                    <input type="file" multiple name="goodsImageFile"></td>
                    <input type="hidden" name="goodsNum" value="${goodsView.goodsNum }"/>
                </tr>
                <tr>
                  <th>용품 상세 내용</th>
                  <td><img src="resources/goodsFile/${goodsView.goodsContents}" alt="상세 내용"/>
                  	  <input type="file" name="goodsContentsFile"/></td>
                </tr>
