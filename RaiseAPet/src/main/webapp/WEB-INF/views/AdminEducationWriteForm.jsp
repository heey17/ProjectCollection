      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="educationBoardWrite" id="writeForm" method="POST" enctype="multipart/form-data">
              <tr>
                <th>제목</th>
                <td><input type="text" name="eduTitle" style="width:100%;"/></td>
              </tr>
              <tr>
                <th>썸네일</th>
              ...
              <tr>
                <th>비디오</th>
                <td><textarea name="eduVideo" cols="120" rows="5" style="resize: none;"></textarea></td>
              </tr>
              <tr>
              	<th>교육 가능한 동물 종류</th>
              ...
              <tr>
                <th>내용</th>
                <td><textarea name="eduContents" cols="40" id="editor1" name="editor1" rows="10" data-sample-short></textarea></td>
              </tr>
              </form>
              <tr>
