...
<div class="medical" style="width:50%; margin:4% auto;">
	<table style="text-align : center; width:100%; height:100%;  border-collapse: collapse; font-family:monospace;">
		<tr>
			<td><img src="resources/medicalFile/의사.jpg" width="30"></td>
			<td>
				오픈된 공간에서 아이의 성격까지 맞춘 안전한 미용<br/>
				그루밍살롱은 트리밍, 스파, 스타일링 등이 가능하며 겉모습 뿐 아니라 피모와 피부 건강까지 함께 관리해 드리고 있습니다.<br/>
				반려견의 성격과 피모상태를 고려하여 맞춤 미용을 진행하며, 외부에서 내부를 확인할 수 있는 공간으로 안심하고 맡기실 수 있습니다.<br/><br/><br/>
				<button style="color:#DDC3F7" onClick="location.href='medicalDoctorList'">의료진 정보보러가기</button>
			</td>
		</tr>
	</table>
</div>
