        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              ...
              <tr>
                <th>디자이너 사진</th>
                <td><img src="resources/beautyFile/${beautyView.designerImage}" alt="디자이너 사진" width="500px;"/></td>
              </tr>
              <tr>
                <th>디자이너 휴무일</th>
              ...
              <tr>
                <td colspan="2"><button onclick="location.href='beautyBoardDelete?designerCode=${beautyView.designerCode}'">삭제</button><button onclick="location.href='beautyBoardModify?designerCode=${beautyView.designerCode}'">수정</button>
                        </td>
              </tr>
            </table>
