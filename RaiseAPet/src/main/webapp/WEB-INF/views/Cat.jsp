	...
	<div id="content" style="margin:0 auto; height:1000px; display: block;">
		...
		<div style="width:80%;" >
			<ul style="float:right; padding-bottom: 40px; padding-top: 40px">
				<li class=""><button class="catbtn" id="HOTEL" onclick="HOTEL()">기본사항</button></li>
				<li class=""><button class="catbtn" id="MEDICAL" onclick="MEDICAL()">기본용품</button></li>
				<li class=""><button class="catbtn" id="BEAUTY" onclick="BEAUTY()">예방접종</button></li>
				<li class=""><button class="catbtn" id="GOODS" onclick="GOODS()">행동수칙</button></li>
			</ul>
		</div>
		<div style="float:right; width:80%;margin-left: 5%">
				<p class="HOTEL"><img src="resources/images/cat_기본사항.png" alt="기본수칙" height="700px"></p>
				<p class="MEDICAL"><img src="resources/images/cat_행동수칙.png" alt="행동수칙 "  height="700px"></p>
				<p class="BEAUTY"><img src="resources/images/cat_예방접종.png" alt="예방접종"  height="700px"></p>
				<p class="GOODS"><img src="resources/images/cat_기본용품.png" alt="기본용품"  height="700px"></p>
		</div>
		</div>
	</div>
	<!--/////////////////////////////////////// 값이 바뀔 구간 끝 /////////////////////////////////////////////////-->
