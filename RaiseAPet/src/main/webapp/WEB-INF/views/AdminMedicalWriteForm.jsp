      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="medicalBoardWrite" id="writeForm" method="POST" enctype="multipart/form-data">
              <tr>
                <th>의사 이름</th>
              ...
              <tr>
                <th>의사 경력</th>
                <td><textarea name="doctorCareer" cols="40" id="editor1" name="editor1" rows="10" data-sample-short></textarea></td>
              </tr>
              <tr>
                <th>의사 진료 과목</th>
                <td><textarea name="doctorSubject" cols="40" id="editor2" name="editor1" rows="10" data-sample-short></textarea></td>
              </tr>
              </form>
              <tr>
