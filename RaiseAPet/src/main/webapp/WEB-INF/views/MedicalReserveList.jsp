        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div style="height:100%">
              ...
              <c:forEach var="reserveList" items="${medicalReserveList}">
			<table style="width:60%;  margin:1% auto; border: 1px solid #444444;">
				<tr><td rowspan="6" style="width:50%; "><img src="resources/medicalFile/${reserveList.doctorImage }" alt="의사 사진" style="width:200px; height:200px"/></td>
					<td colspan="3">${reserveList.doctorName }</td></tr>
				<tr><td colspan="3"><a onclick="goMemberView('${reserveList.medicalReserveUserId}')">${reserveList.medicalReserveUserId}</a></td></tr>
							<!-- 미용 예약한 회원 정보 불러오기 -->
							<script>
				...
				<tr><td>${reserveList.medicalReserveDate }</td><td>/</td><td>${reserveList.medicalReserveTime }</td></tr>
				<tr><td colspan="3">${reserveList.medicalReservePayment }</td></tr>
				<tr><td>${reserveList.medicalReserveAnimalKind }</td>
					<td>/</td>
					<td>${reserveList.medicalReserveAnimalAge } 살</td></tr>
				<tr><td colspan="3">${reserveList.medicalReserveAnimalNote }</td></tr>
			</table>
		</c:forEach>
		<!-- 페이징 구간 -->
