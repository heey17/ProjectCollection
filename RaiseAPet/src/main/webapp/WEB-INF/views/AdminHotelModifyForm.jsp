      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <form action="hotelBoardModifyProcess" id="writeForm" method="POST" enctype="multipart/form-data">
                <tr>
                  <th>방 크기</th>
                  <td><input type="text" name="hotelSize" value="${hotelView.hotelSize }" style="width:70%;"/></td>
                </tr>
                <tr>
                  <th>호텔 방 코드</th>
                  <td>${hotelView.hotelCode }</td>
                  <input type="hidden" name="hotelCode" value="${hotelView.hotelCode }" style="width:70%;"/>
                </tr>
                <tr>
                  <th>호텔 방 이름</th>
                  <td><input type="text" name="hotelRoomName" value="${hotelView.hotelRoomName }" style="width:70%;"/></td>
                </tr>
                <tr>
                  <th>호텔 방 가격</th>
                  <td><input type="text" name="hotelPrice" value="${hotelView.hotelPrice }" onKeyPress="inputNumCom()" style="width:10%;"/> 원</td>
                </tr>
                <tr>
                  <th>최대 수용 가능한 마리 수</th>
                  <td><input type="text" name="hotelMaxAnimal" value="${hotelView.hotelMaxAnimal }" style="width:10%;"/> 마리</td>
                </tr>
                <tr>
                  <th>방 상세 정보</th>
                  <td><textarea name="hotelContents" cols="40" id="editor1" name="editor1" rows="10" data-sample-short>${hotelView.hotelContents }</textarea></td>
                </tr>
                <tr>
                  <th>방 사진</th>
                  <td><img src="resources/hotelFile/${hotelView.hotelRoomImage1 }" alt="호텔 방 사진" class="adminImage"/>
                  		<img src="resources/hotelFile/${hotelView.hotelRoomImage2 }" alt="호텔 방 사진" class="adminImage"/>
                  		<img src="resources/hotelFile/${hotelView.hotelRoomImage3 }" alt="호텔 방 사진" class="adminImage"/>
                  		<img src="resources/hotelFile/${hotelView.hotelRoomImage4 }" alt="호텔 방 사진" class="adminImage"/>
                  		<img src="resources/hotelFile/${hotelView.hotelRoomImage5 }" alt="호텔 방 사진" class="adminImage"/>
                  		<input type="hidden" value="${hotelView.hotelRoomImage1 }" name="hotelRoomImage1"/>
                  		<input type="hidden" value="${hotelView.hotelRoomImage2 }" name="hotelRoomImage2"/>
                  		<input type="hidden" value="${hotelView.hotelRoomImage3 }" name="hotelRoomImage3"/>
                  		<input type="hidden" value="${hotelView.hotelRoomImage4 }" name="hotelRoomImage4"/>
                  		<input type="hidden" value="${hotelView.hotelRoomImage5 }" name="hotelRoomImage5"/>
                  		
                    <input type="file" name="hotelRoomImageFile" multiple/></td>
                </tr>
                </form>
                <tr>
                  <td colspan="2" ><button onclick="window.history.back()" style="float:right;">취소</button>
                  					<button onclick="writeForm.submit()" style="float:right;">작성</button>
                  </td>
                </tr>
