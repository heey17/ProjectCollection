        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table style="margin:0 auto">
              <form action="hotelBoardWrite"  id="writeForm" method="POST" enctype="multipart/form-data">
                <tr>
                  <th>방 크기</th>
                  <td><input type="text" name="hotelSize" style="width:70%"/></td>
                </tr>
                <tr>
                  <th>호텔 방 코드</th>
                  <td><input type="text" name="hotelCode" style="width:70%"/></td>
                </tr>
                <tr>
                  <th>호텔 방 이름</th>
                  <td><input type="text" name="hotelRoomName" style="width:70%;"/></td>
                </tr>
                <tr>
                  <th>호텔 방 가격</th>
                  <td><input type="text" name="hotelPrice" onKeyPress="inputNumCom()" style="width:10%;"/> 원</td>
                </tr>
                <tr>
                  <th>최대 수용 가능한 마리 수</th>
                  <td><input type="text" name="hotelMaxAnimal" style="width:10%;"/> 마리</td>
                </tr>
                <tr>
                  <th>방 상세 정보</th>
                  <td><textarea name="hotelContents" cols="40" id="editor1" name="editor1" rows="10" data-sample-short></textarea></td>
                </tr>
                <tr>
                  <th>방 사진</th>
                  <td  height="500px"><input type="file" name="hotelImageFile" multiple="multiple" "/></td>
                </tr>
                 </form>
                <tr>
