        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              ...
              <tr>
              	<th>교육 가능한 동물 종류</th>
              	<td>${educationView.eduAnimalKind }</td>
              </tr>
              <tr>
                <th>내용</th>
              ...
              <tr>
                <td colspan="2"><button onclick="location.href='educationBoardDelete?eduNum=${educationView.eduNum}'">삭제</button>
                				<button onclick="location.href='educationBoardModify?eduNum=${educationView.eduNum}'">수정</button>
                        </td>
              </tr>
            </table>
