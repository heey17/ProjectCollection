        ...
        <div class="row" >
          <div class="col-lg-12" style="background-color:#eeeeee;">
			...
			<table style="width:60%;  margin:1% auto; border: 1px solid #444444;">
				<tr><td rowspan="6" style="width:50%; text-align:center"><img src="resources/beautyFile/${reserveList.designerImage }" alt="디자이너 사진" style="width:200px; height:200px"/></td>
				...
				<tr><td colspan="3">${reserveList.beautyReserveAnimalNote }</td></tr>
			</table>
		</c:forEach>
		<!-- 페이징 구간 -->
