      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <form action="eventBoardWrite" name="WriteForm" id="writeForm" method="POST" enctype="multipart/form-data">
            <table>
              <tr>
                <th>이벤트 썸네일</th>
                <td><input type="file" name="eventTitleImageFile"/></td>
              </tr>
              <tr>
                <th>이벤트 사진</th>
                <td><input type="file" name="eventImageFile"/></td>
              </tr>
              <tr>
                <th>이벤트 내용</th>
                <td><textarea name="eventContents" cols="40" id="editor1" name="editor1" rows="10" data-sample-short></textarea></td>
              </tr>
              <tr>
                <th>사용할 쿠폰</th>
                <td>
                <!-- 쿠폰 불러오기를 누르면 쿠폰이 불러와지는 영역 -->
                  <div id="couponArea">
