        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <table>
              <tr>
                <td colspan="8">
                  <img src="resources/goodsFile/${goodsView.goodsImage1 }" alt="용품 이미지" style="width:19%;"/>
                  <img src="resources/goodsFile/${goodsView.goodsImage2 }" alt="용품 이미지" style="width:19%;"/>
                  <img src="resources/goodsFile/${goodsView.goodsImage3 }" alt="용품 이미지" style="width:19%;"/>
                  <img src="resources/goodsFile/${goodsView.goodsImage4 }" alt="용품 이미지" style="width:19%;"/>
                  <img src="resources/goodsFile/${goodsView.goodsImage5 }" alt="용품 이미지" style="width:19%;"/>
                </td>
              </tr>
              <tr>
                <th>용품명</th><td colspan="3">${goodsView.goodsName }</td>
                <td style="text-align:center"><img src="resources/svg/eye.svg" alt="조회수 이미지" /></td><td>${goodsView.goodsHit }</td>
                <td style="text-align:center"><img src="resources/svg/favourite-color.svg" alt="좋아요 이미지"/></td><td>${goodsView.goodsLike }</td>
              </tr>
              <tr>
                <th>가격</th><td>${goodsView.goodsPrice} 원</td>
              ...
              <tr>
                <td colspan="8"><button onclick="location.href='goodsBoardDelete?goodsNum=${goodsView.goodsNum}'">삭제</button><button onclick="location.href='goodsBoardModify?goodsNum=${goodsView.goodsNum}'">수정</button>
                        </td>
              </tr>
            </table>
